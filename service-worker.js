const CACHE="dosaljang-v112-20260912c";
const STATIC_ASSETS=["./dosaljang-profile-v112-final.png","./dosaljang-preview-20260912-v112-final2.png","./manifest.webmanifest"];
