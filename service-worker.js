const CACHE="dosaljang-v112-20260912p";
const STATIC_ASSETS=["./dosaljang-profile-v112-clean.png","./dosaljang-preview-20260912-v112-ui-final.png","./manifest.webmanifest"];
